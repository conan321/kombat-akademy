<section id="move-list" class="in-progress">
	...
	<?php include_file('more-btn.php', array('ALL MOVES', '/move-list/?character=homelander')) ?>
</section>
<section id="combos" class="in-progress">
	<h1>COMBOS</h1>
	<?php include_file('more-btn.php', array('MORE COMBOS', '/combos/?character=homelander')) ?>
</section>
